...
public class Level15 : BaseController {
    ...
    public override void enemyDefeated() {
        ...
        if (counter % 4 == 0) Game.LEVEL_CONTROLLER.addObject(enemy_03);
        else if (counter % 4 == 0) Game.LEVEL_CONTROLLER.addObject(enemy_02);
